...
namespace Pic2Website.Pages
{
    public class IndexModel : PageModel
    {
        public List<Tuple<string, string, string>> SampleTemplates = new List<Tuple<string, string, string>>() {
            new Tuple<string, string, string>("images/template4.png", "Portfolio template", "1920x3905px, expected wait time 1 minute"),
            ...
            new Tuple<string, string, string>("images/lms.png", "Learning management system template", "1920x5758px, expected wait time 1 minute"),
            new Tuple<string, string, string>("images/maker.png", "Agency template", "1580x5290px, expected wait time 1 minute"),
            new Tuple<string, string, string>("images/eshop.png", "E-shop 2 template", "1280x1892px, expected wait time 30 seconds"),
            new Tuple<string, string, string>("images/tinyone-1.png", "Simple landing page template", "1400x2280px, expected wait time 1 minute"),
            new Tuple<string, string, string>("images/fb.png", "Facebook.com screenshot", "1920x1065px, expected wait time 1 minute"),
