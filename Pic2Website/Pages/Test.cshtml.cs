...
namespace Pic2Website.Pages
{
    public class TestModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            /*using (var engine = new TesseractEngine("C:/Users/tomsh/source/repos/Pic2Website/Pic2Website/tessdata", "eng", EngineMode.Default))
            {
                // have to load Pix via a bitmap since Pix doesn't support loading a stream.
                using (var image = new System.Drawing.Bitmap("C:/Users/tomsh/source/repos/Pic2Website/Pic2Website/skus.png"))
                {
            ...
            //ocr.Run(new Mat("C:/Users/tomsh/source/repos/Pic2Website/Pic2Website/skus.png"), out string text, out var componentRects, out var componentTexts, out var componentConfidences);
        ...
        {
            var templateParser = new TemplateParser("wwwroot/images/bad-text-2-zoom.png", "1");
