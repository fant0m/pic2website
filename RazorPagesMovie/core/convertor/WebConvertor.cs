...
namespace RazorPagesMovie.core.convertor
{
    public class WebConvertor : IConvertor
    {
        ...
        {
            String htmlStart = "<!DOCTYPE html><html><head><link href=\"./style.css\" rel=\"stylesheet\"><meta charset=\"UTF-8\"><title>Test</title><style>section { width: 100%; }</style></head><body>";
            String htmlBody = "";
